...
router.get('/getProfileUser/:id',
  authUsernMidleware,
  UserController.getProfileUser
);
router.get('/createPlaylist/:id',
  authUsernMidleware,
...
router.post('/addOrDeleteSong/:id',
  authUsernMidleware,
  UserController.addOrDeleteLoveSong
);
router.post('/addOrDeleteAlbum/:id',
  authUsernMidleware,
  UserController.addOrDeleteAlbum
);
router.post('/getOnePlaylist/:id',
  authUsernMidleware,
  UserController.getOnePlaylist
);
router.post('/deletePlaylist/:id',
  authUsernMidleware,
  UserController.deletePlaylist
);
router.post('/updateInforPlaylist/:id',
  upload('Avatar').single('avatar'),
  authUsernMidleware,
  UserController.updateInforPlaylist
);
